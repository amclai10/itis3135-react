        ...
        {error == null ? "" : <p>Error Code {error}</p>}
        {
            introductionData.map((student, index) =>
                <article key={index}>
                    ...
                    <figure>
                        <img src={"https://dvonb.xyz" + student.media.srd} />
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ol>
                                data.courses.map((course, index) => <li key={index}><strong>{course.dept} {course.num} - {course.name}: {course.reason}</strong></li>)
                            </ol>
                        </li>
                        <li>
                    ...
                    <a href={student.links.charlotte}>CLT Web</a> <a href={student.links.gitHub}>GitHub</a> <a href={student.links.githubio}>Github.io</a> <a href={student.links.itis3135}>ITIS 3135</a> <a href={student.links.freecodecamp}>freeCodeCamp</a><a href={student.links.codecademy}>CodeAcademy</a><a href={student.links.linkedin}>linkedIn</a>
                    <hr />
                </article>
            )
